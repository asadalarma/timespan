    ...
    <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <li class="active"><a href="#settings" data-toggle="tab"> Online Games</a></li>
            </ul>
            ...
            <div class="form-group">
                <label for="inputName" class="col-sm-2 control-label">Online Games</label>
                <div class="col-sm-10">
                      <select class="form-control select2" name="online_games" >
                 <?php  
					 
					
					  
					  $query_branches="select * from company where is_deleted=0";
					$result_branches=  mysqli_query($conn,$query_branches);
					  
					  $count_branches=mysqli_num_rows($result_branches);
					  
					   if($count_branches>0)
					   {
						   while($row_branches=mysqli_fetch_array($result_branches))
						   {
							  // echo $row_weapon_type["id"];
							  //  echo $row_weapon_type["name"];
							  echo "<option id=".$row_branches['id']." value=".$row_branches['id']." >".$row_branches['name']."</option>";
               ...
               <div class="form-group">
                  ...
                  <div class="form-group">
                   <label for="inputName" class="col-sm-2 control-label">Source Url</label>


                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="source_url" id="name" placeholder="Source Url">
                    </div>
                  </div>
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="file" class="form-control" name="image" id="description" placeholder="Image">
                    </div>
